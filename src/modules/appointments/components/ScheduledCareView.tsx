...
export function ScheduledCareView() {
  ...
  const today = appointments.filter((item) => item.date === DEMO_TODAY && !["Solicitada","Rechazada"].includes(item.status));
